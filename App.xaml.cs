...
using UiDesktopAppMaster.Services;
using UiDesktopAppMaster.ViewModels.Pages;
using UiDesktopAppMaster.ViewModels.Windows;
using UiDesktopAppMaster.Views.Pages;
using UiDesktopAppMaster.Views.Windows;

namespace UiDesktopAppMaster
{
    /// <summary>
